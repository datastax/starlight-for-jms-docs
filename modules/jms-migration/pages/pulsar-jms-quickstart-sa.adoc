...
This quickstart explains how to prepare an {pulsar-reg} streaming instance, and then use {product} to produce and consume messages with a Java JMS client.
...
If you don't have these structures configured in {astra-stream}, see the xref:astra-stream:getting-started:index.adoc[].
